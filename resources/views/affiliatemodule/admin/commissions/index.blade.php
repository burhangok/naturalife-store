...
Kupondan
                            ...
                            @if($order)
                                <div class="col-auto">
                                    <a href="{{ route('admin.sales.orders.view', $orderId) }}" class="text-decoration-none" title="Siparişi Görüntüle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($commission->affiliate)
                                                <a href="{{ route('admin.affiliatemodule.admin.affiliates.edit', $commission->affiliate_id) }}" class="text-primary">
                                        ...
                                        <td>
                                            @if ($commission->fromAffiliate)
                                                <a href="{{ route('admin.affiliatemodule.admin.affiliates.edit', $commission->from_affiliate_id) }}" class="text-secondary">
