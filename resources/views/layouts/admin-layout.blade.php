...
<head>
    ...
    <title>{{ config('app.name', 'LifeNatura') }} - Temsilcilik Modülü Yönetim Paneli</title>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.affiliatemodule.admin.dashboard') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{ request()->is('admin/affiliatemodule/admin/affiliates*') ? 'active' : '' }}" href="{{ route('admin.affiliatemodule.admin.affiliates.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{ request()->is('admin/affiliatemodule/admin/affiliatepayments*') ? 'active' : '' }}" href="{{ route('admin.affiliatemodule.admin.affiliatepayments.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-file-invoice"></i>
                                    </span>
                                    <span class="nav-link-title">Ödemeler</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link  {{ request()->is('admin/affiliatemodule/admin/commissions*') ? 'active' : '' }}" href="{{ route('admin.affiliatemodule.admin.commissions.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
