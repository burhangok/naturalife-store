...
<head>
    ...
    <title><?php echo e(config('app.name', 'LifeNatura')); ?> - LifeNatura Temsilcilik Yönetim Paneli</title>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                            ...
                            <div class="d-none d-xl-block ps-2">
                                <div> <?php echo e($customer->getNameAttribute()); ?></div>
                                <div class="mt-1 small text-muted"><?php echo e($customer->email); ?></div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">

                            <div class="dropdown-divider"></div>
                            <form method="POST" action="<?php echo e(route('shop.customer.session.destroy')); ?>">
                                <?php echo csrf_field(); ?>
                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  <?php echo e(request()->is('customer/affiliatemodule/profile*') ? 'active' : ''); ?>" href="<?php echo e(route('shop.customers.affiliatemodule.profile',$existingAffiliate)); ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  <?php echo e(request()->is('admin/affiliatemodule/admin/myaffiliates*') ? 'active' : ''); ?>" href="<?php echo e(route('shop.customers.affiliatemodule.myaffiliates')); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-user-circle"></i>
                                    </span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link  <?php echo e(request()->is('scustomers/affiliatemodule/commissions*') ? 'active' : ''); ?>" href="<?php echo e(route('shop.customers.affiliatemodule.commissions',$existingAffiliate)); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('shop.customers.account.profile.index')); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-shopping-cart"></i>
                                    </span>
                                    <span class="nav-link-title">Profilime Dön</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('shop.home.index')); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-shopping-cart"></i>
                                    </span>
...
<?php /**PATH /Users/alfanova/Documents/web projeleri/eticaret/naturalife-store/resources/views/layouts/shop-layout.blade.php ENDPATH**/ ?>