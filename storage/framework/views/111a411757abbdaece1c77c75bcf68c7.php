...
<!-- Komisyon Dağılımı Kartı  //burhangok - 10.05.2025 -->
            <?php if($commissions->count() > 0): ?>
            <div class="card mt-4">
                <div class="card-header">
                    <h3 class="card-title">Sipariş Affiliate Komisyon Dağılımı Detayı</h3>
                </div>
                <div class="card-body">
                    <div class="alert alert-info row">
                        <div class="col-md-6">
                        <i class="fas fa-bill"></i>
                        <strong>Toplam Komisyon Tutarı:</strong> <?php echo e(core()->formatBasePrice($totalCommission)); ?>  + <?php echo e(core()->formatBasePrice($item->base_discount_amount)); ?> : <b><?php echo e(core()->formatBasePrice($item->base_discount_amount + $totalCommission)); ?></b>
                        </div>    <div class="col-md-6"><i class="fas fa-info-circle"></i>
                       <?php
                       $orderTotal= $order->base_sub_total-$order->base_discount_amount;

                        $commissionRate = (($totalCommission+ $item->base_discount_amount)/$orderTotal) * 100;

                       ?>
                            <strong>Toplam Komisyon Oranı:</strong> <?php echo e(round($commissionRate, 2) . "%"); ?> </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">
                                <?php echo e($commission->level); ?>. Seviye Komisyon: <?php echo e(number_format($commission->amount, 2)); ?> Euro -
                                <?php if($commission->affiliate): ?>
                                #<?php echo e($commission->affiliate_id); ?> - <?php echo e($commission->affiliate->affiliate_code); ?>

                                <?php echo e($commission->affiliate->customer->getNameAttribute()  ?? $commission->affiliate->email); ?>
                            ...
                            <div>
                                ...
                                <span class="text-muted ml-2">(%<?php echo e(number_format($commission->percentage, 2)); ?>)</span>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <dl class="row">
                                        <dt class="col-sm-4">Affiliate ID/  Kodu </dt>
                                        <dd class="col-sm-8"><?php echo e($commission->affiliate_id); ?>/<?php echo e($commission->affiliate->affiliate_code); ?></dd>

                                        <dt class="col-sm-4">Komisyon Seviyesi:</dt>
                                        <dd class="col-sm-8"><?php echo e($commission->level); ?>. Seviye</dd>
                                ...
                                <div class="col-md-6">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8">
                                            ...
                                            <a href="<?php echo e(route('admin.affiliatemodule.admin.affiliates.edit', $commission->from_affiliate_id)); ?>">
                                                #<?php echo e($commission->from_affiliate_id); ?> -
                                                <?php echo e($commission->fromAffiliate->customer->getNameAttribute() ?? $commission->fromAffiliate->email); ?>

                                            </a>
                                            <?php elseif($commission->level == 1): ?>
                                            <span class="text-muted">Doğrudan Satış</span>
                                            <?php else: ?>
                                        ...
                                        <dd class="col-sm-8"><?php echo e($commission->created_at->format('d.m.Y H:i')); ?></dd>
                                    </dl>
                                </div>
                            </div>

                            <?php if($commission->description): ?>
                            <div class="mt-3">
                                <h6 class="font-weight-bold">Komisyon Açıklaması:</h6>
                                <div class="p-3 bg-light rounded">
                                    Sipariş #<?php echo e($commission->order_id); ?> için <?php echo e($commission->level); ?>. seviye komisyon (Sepet Tutarı: <?php echo e(number_format(($commission->amount / ($commission->percentage/100)), 2)); ?> Euro)
                                </div>
                            </div>
                            <?php else: ?>
                            <div class="mt-3">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="p-3 bg-light rounded">
                                    <?php if($commission->level == 1): ?>
                                        Bu komisyon, <?php echo e($commission->affiliate->name ?? ''); ?> adlı temsilcinin doğrudan satışından elde edilmiştir.
                                        Sipariş #<?php echo e($commission->order_id); ?> için %<?php echo e(number_format($commission->percentage, 2)); ?> oranında
                                        toplam <?php echo e(number_format($commission->amount, 2)); ?> Euro komisyon ödenecektir.

                                    <?php else: ?>
                                        Bu komisyon, <?php echo e($commission->level); ?>. seviye temsilci ilişkisinden kaynaklanmaktadır.
                                        <?php echo e($commission->fromAffiliate ? '#'.$commission->from_affiliate_id.' - '.$commission->fromAffiliate->name ?? $commission->fromAffiliate->email : 'Belirtilmemiş'); ?>

                                        adlı alt temsilcinin satışından dolayı
                                        #<?php echo e($commission->affiliate_id); ?> - <?php echo e($commission->affiliate->name ?? $commission->affiliate->email); ?> adlı temsilciye
                                        %<?php echo e(number_format($commission->percentage, 2)); ?> oranında toplam <?php echo e(number_format($commission->amount, 2)); ?> Euro
            ...
            <div class="alert alert-info mt-4">
                <i class="fas fa-info-circle"></i> Bu siparişe ait komisyon kaydı bulunmamaktadır.
            </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/alfanova/Documents/web projeleri/eticaret/naturalife-store/packages/Webkul/Admin/src/resources/views/sales/orders/view.blade.php ENDPATH**/ ?>