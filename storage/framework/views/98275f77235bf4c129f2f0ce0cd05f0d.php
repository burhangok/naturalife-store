...
<header class="sticky top-0 z-[10001] flex items-center justify-between border-b bg-white px-4 py-2.5 dark:border-gray-800 dark:bg-gray-900">
    ...
    <div class="flex items-center gap-2.5">
        ...
        >
            <span
                class="icon-configuration cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-100 dark:hover:bg-gray-950"
...
<?php if (! $__env->hasRenderedOnce('f99ba25a-3724-40b2-9527-48d77db51c4a')): $__env->markAsRenderedOnce('f99ba25a-3724-40b2-9527-48d77db51c4a');
...
<?php /**PATH /Users/alfanova/Documents/web projeleri/eticaret/naturalife-store/packages/Webkul/Admin/src/resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>