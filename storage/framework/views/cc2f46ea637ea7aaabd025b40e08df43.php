...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container">
            ...
            <?php
                // Komisyonları siparişlere göre gruplandır
                // Burada collect() ile yeniden sarmalıyoruz çünkü pagination objesi üzerinde groupBy çalışmayabilir
                $commissionCollection = collect($commissions->items());
                ...
                <div class="card mb-4">
                    <div class="card-header border-bottom">
                        <div class="row g-2 align-items-center">
                            <div class="col">
                                ...
                                <?php if($order): ?>
                                    <div class="small text-muted">
                                        ...
                                        + Temsilci İndirimi: <strong class="text-danger"><?php echo e(core()->formatBasePrice($order->base_discount_amount)); ?></strong>
                            ...
                            <?php if($order): ?>
                                <div class="col-auto">
                                    <a href="<?php echo e(route('admin.sales.orders.view', $orderId)); ?>" class="text-decoration-none" title="Siparişi Görüntüle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($commission->affiliate): ?>
                                                <a href="<?php echo e(route('admin.affiliatemodule.admin.affiliates.edit', $commission->affiliate_id)); ?>" class="text-primary">
                                        ...
                                        <td>
                                            <?php if($commission->fromAffiliate): ?>
                                                <a href="<?php echo e(route('admin.affiliatemodule.admin.affiliates.edit', $commission->from_affiliate_id)); ?>" class="text-secondary">
...
<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/alfanova/Documents/web projeleri/eticaret/naturalife-store/resources/views/affiliatemodule/admin/commissions/index.blade.php ENDPATH**/ ?>